    ...
    <section id="team" className="py-24 md:py-36 bg-primary border-t border-white/5">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="max-w-3xl mb-20">
          <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.3em] text-[#ea222d] block mb-2">THE LEADERSHIP</span>
          <h2 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tight mb-6">
            OUR TEAM
          </h2>
          <p className="text-gray-400 text-sm md:text-base font-light leading-relaxed">
            Meet the creative force behind Leela Films—industry pioneers dedicated to modern production systems, cultural storytelling, and visual dominance.
          </p>
        </div>
